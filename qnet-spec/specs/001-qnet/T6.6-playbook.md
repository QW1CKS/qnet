...
**Status: Complete** - All work items implemented; acceptance metrics validated with caveats (VM results documented; bare metal optional for future).
...
Deployment note (user-facing): For user distribution we recommend the Browser Extension + Helper pattern (small extension UI + local `stealth-browser` helper). See `qnet-spec/docs/helper.md` and `qnet-spec/docs/extension.md`. Example default helper endpoints: SOCKS5 `127.0.0.1:1088` and status API `http://127.0.0.1:8088`.
