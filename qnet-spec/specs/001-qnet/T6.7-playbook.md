...
- [ ] Bootstrap seed list + fallback + backoff + caching
  ...
  - [x] Tests: signature verify; backoff under <30s cumulative in failure loop; cache; weighted pick
  - [ ] Health endpoints + integration to dialer loop; acceptance check for <30s first connect
