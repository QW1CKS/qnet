...
- Pending in M2: external bootstrap seeds acceptance run (<30s) and QUIC mode parity; basic DPI harness scripts added.
...
- Bootstrap
  ...
  - Reserve `PREFER_QUIC=0|1` for QUIC parity work (M2→M3), not wired yet.
