...
- Decoy routing
  ...
  - Keep resolver optional; when off, behavior defaults to calibration/allow-list paths, and logs must not expose real destinations beyond localhost. Log redaction still TODO.
