...
- [ ] Scaffold Tauri app in apps/stealth-browser/
- [ ] Embed minimal Rust backend (tokio runtime, config loader)
- [ ] Integrate local SOCKS5 proxy bound on 127.0.0.1:PORT
...
- [ ] Logging: structured logs, rotating files, redact secrets
...
### app scaffolding
- [ ] Create apps/stealth-browser via `tauri init`
- [ ] Add `qnet` workspace integration (Cargo workspace member)
- [ ] Backend: tokio, tracing, serde, config hot-reload
