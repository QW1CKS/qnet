//! Integration tests for circuit building in the mesh network.
//!
//! These tests validate circuit construction, routing table integration,
//! and circuit lifecycle management.
